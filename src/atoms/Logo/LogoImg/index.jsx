...
const LogoImg = ({ width, height, ...props }) => {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 114 119" fill="none">
            <g clipPath="url(#clip0_1_5)" filter="url(#filter0_d_1_5)">
            ...
            <defs>
                <filter id="filter0_d_1_5" x="0" y="0" width="114" height="119" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
